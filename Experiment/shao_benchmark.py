"""
Changepoint metrics
Adapted from Wemqin Shao work
@author: Wenqin Shao (https://github.com/WenqinSHAO/rtt)
Copyright 2016-2017 Wenqin Shao
...
def f1_score(precision,recall):
    if precision!=0 and precision is not None and recall!=0 and recall is not None:
